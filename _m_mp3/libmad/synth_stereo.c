...
static
void synth_full(struct mad_synth *synth, struct mad_frame *frame,
 ...
 */
void mad_synth_frame(struct mad_synth *synth, struct mad_frame *frame)
{
  unsigned int nch, ns;
  void (*synth_frame)(struct mad_synth *, struct mad_frame *,
		      unsigned int, unsigned int);
