/***********************************************************************
 * $Id:: startup.h 8090 2011-09-14 13:57:49Z ing03005                  $
 *
...
/* Finds the DQS range for an uncalibrated DDR system */
int ddr_find_dqsin_delay(UNS_32 start, UNS_32 size);

/* Resyncs DDR clocks after clocks have been changed. This is needed
   if the clock base for the DDR is halted or changed. */
...
/* Range of uncalibrated DQS delay values determined by software
   (DDR only) */
extern int dqsstart, dqsend;
