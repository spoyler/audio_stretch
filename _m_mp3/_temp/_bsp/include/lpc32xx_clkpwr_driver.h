/***********************************************************************
 * $Id:: lpc32xx_clkpwr_driver.h 8090 2011-09-14 13:57:49Z ing03005    $
 *
...
void clkpwr_wk_event_en_dis(CLKPWR_EVENT_T event_id,
                            INT_32 enable) FUNC_SECTION(".clkevents");

/* Get the raw captured status of an event */
INT_32 clkpwr_is_raw_event_active(CLKPWR_EVENT_T event_id) FUNC_SECTION(".clkevents");

/* Get the masked captured status of an event */
INT_32 clkpwr_is_msk_event_active(CLKPWR_EVENT_T event_id) FUNC_SECTION(".clkevents");

/* Clear a captured event status */
void clkpwr_clear_event(CLKPWR_EVENT_T event_id) FUNC_SECTION(".clkevents");

/* Set event signal polarity (0) = falling edge, (1) = rising edge */
void clkpwr_set_event_pol(CLKPWR_EVENT_T event_id,
                          INT_32 high) FUNC_SECTION(".clkevents");
...
void clkpwr_setup_ssp(INT_32 ssp1_rx_dma_en,  /* Will disble SPI2 DMA */
                      ...
                      INT_32 ssp0_tx_dma_en) FUNC_SECTION(".clkssp"); /* Will disble SPI4 DMA */
...
void clkpwr_setup_i2s(INT_32 i2s1_tx_clk_from_rx,
                      ...
                      INT_32 i2s1_use_dma,
                      INT_32 i2s0_use_dma,
                      INT_32 i2s0_tx_clk_from_rx) FUNC_SECTION(".clki2s");
