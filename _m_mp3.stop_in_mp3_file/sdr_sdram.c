/***********************************************************************
 * $Id:: sdr_sdram.c 7848 2011-08-09 13:47:08Z ing03005                $
 *
...
void sdr_sdram_test(void){
unsigned int _i0;
#if 0
  for(_i0=0;_i0<(SDRAM_SIZE>>2);_i0++){
    * ((volatile unsigned int *) (EMC_DYCS0_BASE + (_i0<<2))) = _i0;
  }
  for(_i0=0;_i0<(SDRAM_SIZE>>2);_i0++){
    if(* ((volatile unsigned int *) (EMC_DYCS0_BASE + (_i0<<2))) != _i0)
      goto _error;
  }
  asm("nop");
#endif 
...
#if 1
  for(_i0=0;_i0<(SDRAM_SIZE>>2);_i0++){
    * ((volatile unsigned int *) (EMC_DYCS0_BASE + (_i0<<2))) = 0x55555555;
  }
  for(_i0=0;_i0<(SDRAM_SIZE>>2);_i0++){
    if(* ((volatile unsigned int *) (EMC_DYCS0_BASE + (_i0<<2))) != 0x55555555)
      goto _error;
  }
  asm("nop");
#endif  
