...
//мы всегда находимся в каталоге  
  ...
  struct _level_tab _folder_4[4/*_LEVEL_MAX-2*/]; //каталог закладки 4
  unsigned char _sample_4[15]; //фрагмент закладки 4  
  euint32 _fpos_4;  //позиция в фрагменте закладки 4
  struct _level_tab _folder_5[2/*_LEVEL_MAX-4*/]; //каталог закладки 5
  unsigned char _sample_5[13]; //фрагмент закладки 5  
  euint32 _fpos_5;  //позиция в фрагменте закладки 5
  struct _level_tab _folder_6[2]; //каталог закладки 6
  unsigned char _sample_6[13]; //фрагмент закладки 6  
  euint32 _fpos_6;  //позиция в фрагменте закладки 6  
...
extern void _param_put(unsigned char _p);
