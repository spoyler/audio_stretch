/***********************************************************************
* $Id:: lpc32xx_clkpwr.h 8090 2011-09-14 13:57:49Z ing03005           $
*
...
typedef struct
{
  ...
  volatile UNS_32 reserved8[16];
  volatile UNS_32 clkpwr_uid[4];
} CLKPWR_REGS_T;
...
**********************************************************************/
/* SDRAM RAM_CLK slow slew rate control selection bit */
#define CLKPWR_SDRCLK_SLOWSLEW_CLK _BIT(22)
/* SDRAM grouping fast slew rate control selection bit */
#define CLKPWR_SDRCLK_SLOWSLEW     _BIT(21)
/* SDRAM data fast slew rate control selection bit */
#define CLKPWR_SDRCLK_SLOWSLEW_DAT _BIT(20)
...
#define CLKPWR_TMRPWMCLK_TIMER_EN(tnum) (0x04 << (tnum))
