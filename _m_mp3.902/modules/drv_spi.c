...
{
volatile Int32U * SlaveSetting1 = (Int32U *)(&SPI_SLV0_SETTINGS1+(2*Slave_cnfg->Slave));
volatile Int32U * SlaveSetting2 = (Int32U *)(&SPI_SLV0_SETTINGS2+(2*Slave_cnfg->Slave));
...
Int16U *data16 = NULL;
Int8U *data8 = NULL;
__spi_slv_settings2_bits * SlaveSetting2 = (__spi_slv_settings2_bits *)(&SPI_SLV0_SETTINGS2+(2*Slave));
