...
#define CLK_EN_64_92  (1<<(CLK_256FS-64))
...
static const Int32U FDIV_Config[FDIV23+1]  = 
{
  ...
  /*AHB_APB0_BASE*/
  FDIV_MADD_MSUB(1,4)|FDCTRL_STRETCH|FDCTRL_ENABLE,  /*FDIV7 1/4*/
  ...
  FDIV_MADD_MSUB(1,8)|FDCTRL_STRETCH|FDCTRL_ENABLE,     /*FDIV18 1/4  */
  FDIV_MADD_MSUB(1,2)|FDCTRL_STRETCH,                   /*FDIV19 1/2*/
  FDIV_MADD_MSUB(1,8)|FDCTRL_STRETCH|FDCTRL_ENABLE,    /*FDIV20 3/16*/
...
CGU_CLOCKS ClockID;
  ...
  while(!(HP0_STATUS & 1)); /*Wait untill PLL locks*/
