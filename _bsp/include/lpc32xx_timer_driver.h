/***********************************************************************
 * $Id:: lpc32xx_timer_driver.h 8090 2011-09-14 13:57:49Z ing03005     $
 *
...
INT_32 timer_open(void *ipbase,
                  INT_32 arg) FUNC_SECTION(".tmropn");

/* Close the timer */
STATUS timer_close(INT_32 devid) FUNC_SECTION(".tmrclose");

/* Timer configuration block */
STATUS timer_ioctl(INT_32 devid,
                   INT_32 cmd,
                   INT_32 arg) FUNC_SECTION(".tmrioctl");

/* Timer read function (stub only) */
INT_32 timer_read(INT_32 devid,
                  void *buffer,
                  INT_32 max_bytes) FUNC_SECTION(".tmrrd");

/* Timer write function (stub only) */
INT_32 timer_write(INT_32 devid,
                   void *buffer,
                   INT_32 n_bytes) FUNC_SECTION(".tmrwr");
